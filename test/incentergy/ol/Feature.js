sap.ui.define([
...
], function(Feature, Style, Circle, Vector, Control) {
    "use strict";
    ...
    QUnit.test("Test setWkt", function(assert) {
        ...
        var oMockParentLayerSource = new Control();
        oMockParentLayerSource.mapSet = sinon.stub().returns(Promise.resolve());
        oMockParentLayerSource._source = {
            "addFeature": sinon.stub()
        };
        var oMockParentLayer = new Control();
        oMockParentLayer.mapSet = sinon.stub().returns(Promise.resolve());
        oMockParentLayerSource.setParent(oMockParentLayer);

        oFeature.setParent(oMockParentLayerSource);
...
//        oMockParentLayer.mapSet().then(function () {
//        	console.log("oMockParentLayer mapSet resolved.");
//        });
//        oMockParentLayerSource.mapSet().then(function () {
//        	console.log("oMockParentLayerSource mapSet resolved.");
//        });
//        oFeature._layerSet().then(function () {
//        	console.log("oFeature _layerSet resolved.");
//        });
        
        Promise.all([oMockParentLayer.mapSet(), oFeature._layerSet(), oMockParentLayerSource.mapSet()]).then(function() {
            assert.ok(oMockParentLayerSource._source.addFeature.called, "addFeature was called");
            done();
        })
    });
