sap.ui.define([
    ...
    QUnit.test("Test setWkt", function(assert) {
        ...
        oFeature._pLayerSet = Promise.resolve();
        ...
        Promise.all([oMockParentLayer.mapSet(), oFeature._pLayerSet, oMockParentLayerSource.mapSet()]).then(function() {
            assert.ok(oMockParentLayerSource._source.addFeature.called);
            done();
        })
    });
